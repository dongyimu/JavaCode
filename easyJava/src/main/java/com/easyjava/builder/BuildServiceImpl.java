...
public class BuildServiceImpl {
    ...
    public static void execute(TableInfo tableInfo) {
        ...
        String mapperBeanName = StringUtils.lowerFirstLetter(mapperName);
        ...
        try {
            ...
            bw.write("@Service(\"" + StringUtils.lowerFirstLetter(tableInfo.getBeanName()) + "Service\")");
            bw.newLine();
            ...
            bw.newLine();
            bw.write("\t\tPaginationResultVO<" + tableInfo.getBeanName() + "> result = new PaginationResultVO(count, page.getPageNo(), page.getPageTotal(), list);");
            bw.newLine();
